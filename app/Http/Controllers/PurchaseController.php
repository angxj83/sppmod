    ...
    public function index(Request $request)
    {
        ...
        if($role->hasPermissionTo('purchases-index')) {            
            /*if(Auth::user()->role_id > 2 && config('staff_access') == 'own')
                $lims_purchase_list = Purchase::orderBy('id', 'desc')->where('user_id', Auth::id())->paginate(10);
            else
                $lims_purchase_list = Purchase::orderBy('id', 'desc')->paginate(10);*/
            ...
            return view('purchase.index', compact( 'lims_account_list', 'all_permission', 'lims_pos_setting_data', 'starting_date', 'ending_date'));
        }
        else
